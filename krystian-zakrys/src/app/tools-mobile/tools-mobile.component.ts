...
@Component({
  ...
  templateUrl: './tools-mobile.component.html',
  styleUrls: ['./tools-mobile.component.scss']
})
export class ToolsMobileComponent implements OnInit {
 tools: Tool[] = [
    ...
    { imageUrl: '../../assets/tools/azure.svg', name: 'Azure' },
    { imageUrl: '../../assets/tools/notion.svg', name: 'Notion' },
    { imageUrl: '../../assets/tools/figma.svg', name: 'Figma' },
    { imageUrl: '../../assets/tools/mirro.svg', name: 'Mirro' },
